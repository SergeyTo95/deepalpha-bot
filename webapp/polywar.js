...
class PolyWarMap {
  ...
  updatePanel() {
    ...
    const combatModes = new Set(["capture", "attack", "reinforce"]);
    if (combatModes.has(actionMode)) { if (canAttack) actionMode = "attack"; else if (canReinforce) actionMode = "reinforce"; else if (canCapture) actionMode = "capture"; }
