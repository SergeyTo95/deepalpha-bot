...
class PolyWarMap {
  constructor(state) {
    ...
    this.squads = []; this.squadPressure = []; this.squadSeq = 0; this.squadAbort = null; this.squadRefreshTimer = null; this.squadDebounceTimer = null; this.squadOverviewTimer = null; this.lastSquadOverviewRefresh = 0; this.squadAnimations = new Map(); this.squadSupportEnergyCost = 1;
