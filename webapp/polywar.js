...
class PolyWarMap {
  constructor(state) {
    ...
    this.squads = []; this.squadPressure = []; this.squadSeq = 0; this.squadAbort = null; this.squadRefreshTimer = null; this.squadAnimations = new Map();
