...
TOKEN = "stage67-prod-acceptance-post-budget-20260825-2212"
CANARY_PATH = "velia_stage67_acceptance_post_budget_canary.py"
PREVIOUS_FACTORY_RUN_ID = "18ae6a6c-2e3e-4058-8124-6b7d90da0d5d"
...
def build_single_step_spec(project_id: str):
    goal = (
        "Controlled Stage 6.7 reviewer-remediation canary after the Senior Reviewer Gemini output-budget hotfix. "
    ...
    return {
        ...
        "title": "Stage 6.7 post-budget single-step reviewer-remediation canary",
        "objective": goal,
        "acceptance_criteria": [
        ...
        "metadata": {
            ...
            "temporary": True,
            "developer_steps": 1,
            "post_reviewer_output_budget_hotfix": True,
        },
    }
