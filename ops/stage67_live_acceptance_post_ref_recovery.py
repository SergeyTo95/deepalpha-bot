...
TOKEN = "stage67-prod-acceptance-post-ref-recovery-20260825-2221"
CANARY_PATH = "velia_stage67_acceptance_post_ref_recovery_canary.py"
PREVIOUS_FACTORY_RUN_ID = "2e2dc56c-a771-4c46-a38c-459882c302aa"
...
def build_single_step_spec(project_id: str):
    goal = (
        "Controlled Stage 6.7 reviewer-remediation canary after verified recovery from a transient GitHub ref-update failure. "
    ...
    return {
        ...
        "title": "Stage 6.7 clean reviewer-remediation acceptance rerun",
        "objective": goal,
        "acceptance_criteria": [
        ...
        "metadata": {
            ...
            "temporary": True,
            "developer_steps": 1,
            "clean_rerun_after_transient_ref_recovery": True,
        },
    }
