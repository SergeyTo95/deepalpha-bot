...
html{-webkit-text-size-adjust:100%;width:100%;max-width:100%;overflow-x:hidden;scroll-padding-bottom:calc(82px + env(safe-area-inset-bottom))}
body{width:100%;max-width:100%;min-width:0;overflow-x:hidden;overscroll-behavior-y:contain}
...
.main{width:100%;max-width:100vw;min-width:0;overflow-x:hidden;padding:max(16px,env(safe-area-inset-top)) 12px calc(24px + env(safe-area-inset-bottom))!important}.topline{gap:10px;align-items:center!important;margin-bottom:16px!important}h1{font-size:clamp(21px,6vw,26px)!important;line-height:1.12}h2{font-size:16px;line-height:1.25}.subtitle{max-width:72vw;margin-top:4px;font-size:11px;line-height:1.35}.topline>.pill{flex:0 0 auto;padding:5px 8px;font-size:10px}
