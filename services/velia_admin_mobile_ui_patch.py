...
html{-webkit-text-size-adjust:100%;width:100%;max-width:100%;overflow-x:hidden;overflow-y:auto!important;overscroll-behavior-y:auto;-webkit-overflow-scrolling:touch;scroll-padding-bottom:calc(82px + env(safe-area-inset-bottom))}
body{width:100%;max-width:100%;min-width:0;min-height:100dvh;height:auto!important;overflow-x:hidden;overflow-y:visible!important;overscroll-behavior-y:auto;touch-action:pan-x pan-y pinch-zoom}
...
.brand{display:none!important}.navs{min-width:0;flex:1 1 auto;display:flex!important;gap:6px!important;overflow-x:auto!important;overflow-y:hidden;padding:0!important;scroll-snap-type:x proximity;scrollbar-width:none;-webkit-overflow-scrolling:touch;touch-action:pan-x pan-y pinch-zoom}.navs::-webkit-scrollbar{display:none}
...
.main{width:100%;max-width:100vw;min-width:0;overflow-x:hidden;padding:max(16px,env(safe-area-inset-top)) 12px calc(24px + env(safe-area-inset-bottom))!important;touch-action:pan-y pinch-zoom}.topline{gap:10px;align-items:center!important;margin-bottom:16px!important}h1{font-size:clamp(21px,6vw,26px)!important;line-height:1.12}h2{font-size:16px;line-height:1.25}.subtitle{max-width:72vw;margin-top:4px;font-size:11px;line-height:1.35}.topline>.pill{flex:0 0 auto;padding:5px 8px;font-size:10px}
...
.table-wrap{max-width:100%!important;overflow:visible!important;border:0!important;border-radius:0!important;background:transparent!important;touch-action:pan-y pinch-zoom}
