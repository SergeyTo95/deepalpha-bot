...
class ChiefForecaster(TopAnalysisSpecialistBase):
    ...
    def run(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            ...
            "forecast_pick": parsed.get("forecast_pick", ""),
            "best_outcome": parsed.get("best_outcome", parsed.get("forecast_pick", "")),
            "pick_confidence": parsed.get("pick_confidence", ""),
            "pick_strength": parsed.get("pick_strength", ""),
            "value_strength": parsed.get("value_strength", ""),
