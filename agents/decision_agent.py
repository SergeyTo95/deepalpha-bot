...
class DecisionAgent:
    ...
    def run(
        ...
        raw_response = generate_decision_text(prompt, feature="decision_agent" if is_background else "signal_generation", is_background=is_background, cycle_id=cycle_id, job_id=job_id)
