    ...
    def run(
        ...
        for raw_market in raw_markets:
            try:
                ...
                news_data = self.news_agent.run(market_data, lang=lang, is_background=is_background, request_id=request_id, cycle_id=cycle_id, job_id=job_id)
                decision_data = self.decision_agent.run(market_data, news_data, lang=lang, is_background=is_background, request_id=request_id, cycle_id=cycle_id, job_id=job_id)
