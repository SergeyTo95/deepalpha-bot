...
async def admin_settings(r):
    ...
    labels={"token_price_ton":"Token price, Gram","subscription_price_ton":"Subscription price, Gram","analysis_price_tokens":"Analysis price, tokens","cached_signal_price_tokens":"Cached signal price, tokens","opportunity_price_tokens":"Opportunity price, tokens","web_payments_enabled":"Web payments enabled","web_tron_usdt_enabled":"Web TRON USDT enabled"}
    if r.method=='POST':
        f=await r.post()
        for k in keys:
