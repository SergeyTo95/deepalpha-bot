...
python -m pytest -vv --maxfail=1   tests/test_velia_research_center.py   tests/test_velia_research_literature.py   tests/test_velia_research_reasoning.py   tests/test_velia_research_evidence_claims.py   tests/test_velia_research_director.py   tests/test_velia_research_report.py   tests/test_velia_context_efficiency.py   tests/test_velia_projects.py

python -m compileall -q   services/velia_context_efficiency_service.py   services/velia_research_safety_service.py   services/velia_research_center_service.py   services/velia_research_literature_service.py   services/velia_research_search_quality_service.py   services/velia_research_reasoning_service.py   services/velia_research_evidence_claim_service.py   services/velia_research_director_service.py   services/velia_research_report_service.py   run_velia_research_worker.py   velia_research_routes.py   velia_project_routes.py
